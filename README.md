...
#### _A Web Page For Learning About DOM Manipulation, 1/10/2020_

#### By _**Todd Walraven**_

## Description

_This application allows the user to click on elements on the page to show or hide elements through the DOM_
